...
const ScrollUpBtn = () => {
    ...
    return (
        <div className={`fixed flex items-center justify-center rounded-full cursor-pointer text-white font-semibold bg-c_1564C0 ${enableScrollUpBtn === false ? 'hidden' : 'block'}
