                ...
                <div className="block sm:hidden">
                    ...
                    <div className="flex items-center justify-center py-4">
                        <div className="w-6 h-6 rounded-full flex items-center justify-center cursor-pointer transform hover:scale-110 ease-out duration-700
                                        ...
                                        ">
                            <BsTwitter className=" text-c_1564C0 dark:text-c_232323"/>
                        </div>
                        <div className="w-6 h-6 rounded-full flex items-center justify-center ml-8 cursor-pointer transform hover:scale-110 ease-out duration-700
                                        bg-white dark:bg-white">
                            <BsInstagram className=" text-c_1564C0 dark:text-c_232323"/>
                        </div>
                        <div className="w-6 h-6 rounded-full flex items-center justify-center ml-8 cursor-pointer transform hover:scale-110 ease-out duration-700
                                        bg-white dark:bg-white">
                            <FaTelegramPlane className="text-c_1564C0 dark:text-c_232323"/>
                        </div>
                        <div className="w-6 h-6 rounded-full flex items-center justify-center ml-8 cursor-pointer transform hover:scale-110 ease-out duration-700
                                        bg-white dark:bg-white">
                            <FaDiscord className="text-c_1564C0 dark:text-c_232323"/>
                        </div>
                    </div>
                </div>
                
                <div className="bg-c_2A7BD9 dark:bg-c_2F2F2F h-0.5 w-full"></div>
