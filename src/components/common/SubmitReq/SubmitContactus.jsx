    ...
    return (
        <>
            <div className="pl-13 pr-9 mt-15 flex flex-col text-sm font-medium text-black dark:text-c_F0F0F0">
                ...
                <span className="mt-4">For any queries, please complete this form</span>
                <div className="mt-12 flex flex-col gap-y-10">
                    ...
                    <div className="flex w-full max-w-2xl">
                        <div className="w-44">
                            <span className="font-semibold">Description<span className="ml-1 text-c_C85151">*</span></span>
                        </div>
                        <div className="flex-1 flex items-end">
                            <textarea className="p-3 w-full text-xs rounded border dark:placeholder-c_8A8A8A border-transparent dark:border-c_4D4D4D bg-white dark:bg-transparent shadow-card dark:shadow-none" rows={10} placeholder="Type description" />
                            <span className="ml-2.5 text-xs dark:text-c_8A8A8A w-14">500/500</span>
                        </div>
                    </div>
                    <div className="flex w-full max-w-2xl">
