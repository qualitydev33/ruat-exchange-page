...
const DerivativeTable = ({table_data}) => {
            ...
            <div className="overflow-x-auto w-full">
                <div className="text-black dark:text-white" style={{width: 1104 + 'px'}}>
                    <div className="flex items-center px-3 w-full font-bold py-4
                        ...
                        <div className="w-52 pl-5 text-right">Volume(24h)</div>
                        <div className="text-right w-32">Maker Fees</div>
                        <div className="text-right w-25">Taker Fees</div>
                        <div className="text-right w-40">Open Interests</div>
                        <div className="text-right w-25">No.Markets</div>
                        <div className="text-center flex-1">Launched</div>
                    </div>
                        ...
                        {table_data.map((item, index) => {
                            return <div key={`data_${index}`} className="flex flex-col">
                                        <div className={`px-3 flex items-center w-full h-71px border-b border-c_E8EBF1 dark:border-c_2F2F2F`}>
                                            ...
                                            <div className={`flex items-center justify-end font-semibold w-40`}>
                                                <div>${Number(item.item5).toLocaleString()}</div>
                                            </div>
                                            <div className={`flex items-center justify-end font-semibold w-25`}>
                                                <div>{item.item6}</div>
                                            </div>
                                            <div className="flex-1 flex items-center justify-center font-semibold">{item.item7}</div>
                                        </div>
...
export default DerivativeTable